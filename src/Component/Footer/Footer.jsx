        ...
        <Container >
            ...
            <div className="bg-[#38C6BC] h-[354px] sm:h-[155px] rounded-lg flex justify-between relative" >
                ...
                <div className="flex items-end">
                    ...
                    <img className="hidden sm:inline-block" src={footerMobilePic1} alt="" />
                ...
                <div className=" absolute top-1/4 flex flex-col gap-12 sm:gap-4 justify-center items-center w-full">
                    <BigHeading 
                        className={'text-[white] font-bold w-[40%] sm:w-full sm:!text-[16px] text-center'}
                ...
                <div className="">
                    ...
                    <img className="hidden sm:inline-block" src={footerMobilePic2} alt="" />
