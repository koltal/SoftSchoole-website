    ...
    <Container className="px-40 mt-20">
        <Row className={' items-center sm:flex-col sm:gap-10'}>
            ...
            <div className="flex flex-col gap-3 w-[50%] sm:w-full">
                ...
                <BigHeading 
                    className={'font-medium w-[30%] leading-9 sm:leading-6 sm:font-semibold'}
...
const Temp = ({id, arrayLength}) => {
    return (
        <div 
            key={id} 
            className={`border-y-1 ${id !== arrayLength && 'border-b-0'} border-[#C0CCCB] py-5 sm:py-4 flex justify-between items-center`}>
        <LighterText className={'text-[#222222] sm:text-[black] sm:font-semibold'} text={'How many people can use Nitroserve'}/>
