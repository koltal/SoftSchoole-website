        ...
        <div className="flex flex-col gap-12">
            ...
            <Container className="!pt-0 !pb-0">
                <ShowCase
                    ...
                    text={'You can reach out to multiple members of your team, communicate better work better together'}
                    image={mainImage1}
                />
            </Container>

            <div className="w-[70%] border-t-2 border-dashed" />
            ...
            <Container className="!pt-0 !pb-0">
                <ShowCase
                    ...
                    text={'It is possible to connect to one person on the team or multiple people at once through groups'}
                    image={mainImage2}
                />
