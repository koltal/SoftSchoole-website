      ...
      <div className="flex flex-col gap-12">
        <Container className="!pt-0 !pb-0">
          <ShowCase
            ...
            text={
              "For better management, a group of tasks can be grouped into a board and be treated seperately from other tasks"
            }
            image={mainImage1}
          />
        </Container>
        ...
        <Container className="!pt-0 !pb-0">
          <ShowCase
            ...
            text={
              "Track the progress of different tasks and update the status of these tasks as you go"
            }
            image={mainImage2}
          />
        </Container>
